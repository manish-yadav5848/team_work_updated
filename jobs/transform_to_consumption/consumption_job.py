...
def load_file_in_consumption(spark: SparkSession, job_arguments: ConsumptionJobArguments):
    ...
    if job_arguments.consumption_entity_name in JobNameToJobMapper:
        ...
        consumption_df = JobNameToJobMapper[job_arguments.consumption_entity_name](spark, job_arguments.batch_date, consumption_parameters.primary_keys)
    else:
    ...
    if consumption_df:
        ...
        # Add delta_op_col column
        # I -> upserts (inserts and updates)
        # D -> deletes
        # consumption_df = add_delta_op_col(
        #     spark=spark,
        #     database_name=database_name,
        #     table_name=table_name,
        #     df=consumption_df,
        #     primary_key=consumption_parameters.primary_keys
        # )
        ...
        # Consumption database need not have delta_op_column. This column is only required for consumption_stage

        # consumption_db_df = consumption_df.drop("delta_op_col")
        # consumption_stage_df = consumption_df
