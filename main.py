...
from wealthcentral.jobs.transform_to_consumption.historical_consumption_job import historical_load_file_in_consumption
from wealthcentral.utils.config_utils import (
    parse_job_arguments,
    load_env_variables,
    parse_staging_job_arguments,
    parse_raw_job_arguments, parse_transform_job_arguments, parse_consumption_job_arguments
)
import os
import logging
...
if __name__ == "__main__":
    ...
    elif job_arguments.job_name == 'historical_load_consumption':
        # Load Staging Job Arguments
        consumption_job_arguments = parse_consumption_job_arguments()
        logger.info('Parsed Consumption Job Arguments: batch_date: %s, consumption_entity_name: %s, client_name: %s',
                    consumption_job_arguments.batch_date,
                    consumption_job_arguments.consumption_entity_name,
                    consumption_job_arguments.client_name
                    )

        historical_load_file_in_consumption(
            spark=spark,
            job_arguments=consumption_job_arguments,
        )